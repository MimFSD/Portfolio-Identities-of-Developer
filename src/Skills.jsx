...
const Skills = () => {
  return (
    <div
      className="section skills-section mx-4 md:mx-10 mt-24 lg:mx-14 mb-20"
      id="skills"
    >
      ...
      <h1 className="text-center">
        I solved almost 800+ problem in various judge such links
      </h1>
      <div className="flex justify-center items-center mt-2 space-x-6 mb-20">
        ...
        <a
          href="https://www.codechef.com/users/2000"
          target="_blank"
          rel="noopener noreferrer"
